    ...
    <form onSubmit={handleLogin} className="space-y-6">
      ...
      <div className="relative mb-6">
        ...
        <div className="relative flex justify-center text-sm">
          <span
            className={`${themeClasses.bgLog} px-4 ${themeClasses.textSecondary}`}
          >
      ...
      <div className="text-center">
        ...
        <Link
          href="/signup"
          className="text-sm text-green-500 hover:text-green-600 transition-colors duration-200 font-medium"
        >
          Sign up
        </Link>
      </div>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          transform: `translate(${mousePositionRef.current.x * 0.02}px, ${
            mousePositionRef.current.y * 0.02
          }px)`,
        }}
      />
      ...
      {/* Navigation */}
      <nav
        className={`fixed top-0 left-0 right-0 z-40 py-6 ${themeClasses.navBg} backdrop-blur-xl shadow-xl`}
      >
        <div className="max-w-7xl mx-auto px-8 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link
              href="/"
              className={`flex items-center space-x-2 px-4 py-2 rounded-full ${themeClasses.border} ${themeClasses.bgHover} transition-all duration-300`}
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-12">
              <div>
                ...
                <p
                  className={`text-xl font-light ${themeClasses.textSecondary} leading-relaxed`}
                >
                  {currentPage === "login"
              ...
              <div className="space-y-6">
                {[
                  ...
                  >
                    <div
                      className={`w-12 h-12 rounded-xl ${themeClasses.cardBg} border ${themeClasses.border} flex items-center justify-center`}
                    >
                      {feature.icon}
                    </div>
                    <div>
                      <h3 className="font-light text-lg mb-1">
                        {feature.title}
                      </h3>
            ...
            <div className="relative">
              <div
                className={`${themeClasses.cardBg} border ${themeClasses.border} rounded-3xl p-8 shadow-2xl backdrop-blur-sm`}
              >
      ...
      {/* Footer */}
      <footer
        className={`py-8 px-8 ${themeClasses.cardBg} border-t ${themeClasses.border}`}
      >
        <div

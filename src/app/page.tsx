...
const Logo = () => (
  ...
  return (
    <div className={`min-h-screen ${themeClasses.bg} ${themeClasses.text} overflow-x-hidden transition-colors duration-700`}>
      ...
      {/* Hero Section */}
      <section id="home" ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden  mt-20">
        ...
        <div className="relative z-10 text-center px-8 max-w-6xl mx-auto">
          ...
          >
            ...
            <span className={`text-sm font-light tracking-wide ${themeClasses.accent}`}>Trusted by 10,000+ professionals</span>
          </div>
          ...
          >
            ...
            <span className="block bg-gradient-to-r from-green-500 to-emerald-500 bg-clip-text text-transparent">Intelligence</span>
          </h1>
          ...
          >
            Track property prices, analyze market trends, and make data-driven decisions with our premium AI-powered platform.
          </p>
          ...
          >
            <button className={`group relative overflow-hidden bg-green-500 text-white hover:bg-green-600 px-8 py-4 rounded-full font-light text-lg transition-all duration-500 tracking-wide shadow-lg hover:shadow-xl ${themeClasses.accentGlow}`}>
            ...
            <button className={`group flex items-center space-x-2 px-8 py-4 rounded-full font-light text-lg border ${themeClasses.accentBorder} text-green-500 hover:bg-green-500 hover:text-white transition-all duration-500 tracking-wide`}>
      ...
      <section className={`py-20 px-8 ${themeClasses.cardBg} shadow-lg`}>
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              { number: "10K+", label: "Active Users", color: "text-green-500" },
              { number: "2.5M+", label: "Properties Tracked", color: "text-emerald-500" },
              { number: "150+", label: "Cities Covered", color: "text-green-600" },
              { number: "99.9%", label: "Uptime", color: "text-emerald-600" }
            ].map((stat, index) => (
              <div key={index} className="text-center">
                <div className={`text-4xl md:text-5xl font-light mb-2 ${stat.color}`}>{stat.number}</div>
                <div className={`text-sm font-light ${themeClasses.textSecondary} tracking-wider uppercase`}>{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            <h2 className="text-5xl md:text-6xl font-light mb-6 tracking-tight">
              <span className={themeClasses.textMuted}>Everything</span> You Need
            </h2>
            <p className={`text-xl font-light ${themeClasses.textSecondary} max-w-2xl mx-auto leading-relaxed`}>
              Professional tools for real estate analysis and market intelligence
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              >
                <div className="mb-6">
                  <div className={`w-12 h-12 border ${themeClasses.border} rounded-full flex items-center justify-center group-hover:border-green-500 transition-all duration-500 ${feature.color}`}>
                    {feature.icon}
                  </div>
                </div>
                <h3 className="text-xl font-light mb-3 tracking-wide">{feature.title}</h3>
                <p className={`${themeClasses.textSecondary} font-light leading-relaxed`}>{feature.desc}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          {[
            ...
            >
              <div className="text-center relative z-10">
                ...
                <p className={`${themeClasses.textSecondary} font-light mb-4`}>{item.desc}</p>
                <div className={`text-sm font-light ${item.color} tracking-wider`}>
      ...
      <section id="pricing" className={`py-32 px-8 ${themeClasses.bg}`}>
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-24">
            <h2 className="text-5xl md:text-6xl font-light mb-6 tracking-tight">
              Simple <span className="bg-gradient-to-r from-green-500 to-emerald-500 bg-clip-text text-transparent">Pricing</span>
            </h2>
            <p className={`text-xl font-light ${themeClasses.textSecondary} max-w-2xl mx-auto leading-relaxed`}>
            ...
            {[
              {
                ...
                price: "$29",
                period: "/month",
                features: ["Up to 100 properties", "Basic analytics", "Email support", "Mobile app access"],
                popular: false
              },
              {
                name: "Professional",
                price: "$99",
                period: "/month",
                features: ["Up to 1,000 properties", "Advanced analytics", "Priority support", "API access", "Team collaboration"],
                popular: true
              },
              {
                name: "Enterprise",
                price: "Custom",
                period: "",
                features: ["Unlimited properties", "Custom integrations", "Dedicated support", "White-label options", "Advanced security"],
                popular: false
              }
            ].map((plan, index) => (
              <div
                key={index}
                className={`relative p-8 border ${themeClasses.border} rounded-2xl transition-all duration-700 ${themeClasses.borderHover} ${themeClasses.bgHover} hover:shadow-xl ${plan.popular ? 'ring-2 ring-green-500 shadow-green-500/20' : ''}`}
              >
                {plan.popular && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                    <span className="bg-green-500 text-white px-4 py-1 rounded-full text-sm font-light">Most Popular</span>
                  </div>
                )}
                <div className="text-center">
                  <h3 className="text-2xl font-light mb-4">{plan.name}</h3>
                  <div className="mb-6">
                    <span className="text-4xl font-light text-green-500">{plan.price}</span>
                    <span className={`${themeClasses.textSecondary} font-light`}>{plan.period}</span>
                  </div>
                  <ul className="space-y-3 mb-8">
                    {plan.features.map((feature, featureIndex) => (
                      <li key={featureIndex} className="flex items-center space-x-3">
                        <Check className="w-5 h-5 text-green-500" />
                        <span className={`${themeClasses.textSecondary} font-light`}>{feature}</span>
                      </li>
                    ))}
                  </ul>
                  <button className={`w-full py-3 rounded-full font-light border ${plan.popular ? 'bg-green-500 text-white border-green-500 hover:bg-green-600' : `${themeClasses.accentBorder} text-green-500 hover:bg-green-500 hover:text-white`} transition-all duration-300`}>
                    Get Started
                  </button>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
            {[
              ...
              <div key={index} className="text-center">
                <div className={`text-6xl font-light mb-6 ${item.color}`}>{item.step}</div>
                <h3 className="text-2xl font-light mb-4 tracking-wide">{item.title}</h3>
                <p className={`${themeClasses.textSecondary} font-light leading-relaxed`}>{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
     ...
     <section id="testimonials" className={`py-24 px-8 ${themeClasses.bg}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {[
            {
              name: "Aarav Mehta",
              feedback: "ZonePulse helped me pick the best investment zone in Pune. Charts are 🔥",
            },
            {
              name: "Shruti R",
              feedback: "I love how easy the dashboard is. Dark mode is a plus 😍",
            },
            {
              name: "Vikram Sinha",
              feedback: "Very helpful for analyzing Bangalore property rates. Saved me hours.",
            },
          ].map((user, index) => (
            <div key={index} className={`p-6 rounded-xl shadow-md ${themeClasses.cardBg}`}>
              <p className="mb-4">“{user.feedback}”</p>
              <div className="text-sm font-semibold text-blue-500">{user.name}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="contact" className={`py-24 px-8 ${themeClasses.bg}`}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className={`text-xl font-light ${themeClasses.textSecondary} mb-12`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
            {[
              ...
              <div key={index} className={`flex items-start space-x-4 border ${themeClasses.border} p-6 rounded-2xl`}>
                {item.icon}
                <div>
                  <div className="font-light">{item.label}</div>
                  <div className={`${themeClasses.textSecondary} text-sm`}>{item.value}</div>
                </div>
              </div>
            ))}
          </div>
      ...
      <footer className={`py-12 px-8 ${themeClasses.cardBg}`}>
        <div className={`max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 text-sm font-light ${themeClasses.textSecondary}`}>
          ...
          <div className="flex space-x-4">
            <a href="https://twitter.com" target="_blank" className="hover:text-white"><Twitter size={18} /></a>
            <a href="https://linkedin.com" target="_blank" className="hover:text-white"><Linkedin size={18} /></a>
            <a href="https://github.com/CosmicMagnetar" target="_blank" className="hover:text-white"><Github size={18} /></a>
            <a href="https://instagram.com" target="_blank" className="hover:text-white"><Instagram size={18} /></a>
          </div>
        </div>
      </footer>
    </div>
